...
/******/ 	var hotCurrentHash = "b7cb5de38c2927d1b1cf"; // eslint-disable-line no-unused-vars
...
exports.default = (0, _reactRedux.connect)(function (state) {
    return {
        ...
        itemsForeRemovingLength: state.store.items.filter(function (item) {
...
var render = function render() {
  _reactDom2.default.render(_react2.default.createElement(
    ...
    { store: store },
    _react2.default.createElement(_App2.default, { data: store })
 ...
 * LICENSE file in the root directory of this source tree.
 */
var m=__webpack_require__(13),n=__webpack_require__(14),p=__webpack_require__(5);
...
*/
var aa=__webpack_require__(1),m=__webpack_require__(17),A=__webpack_require__(18),B=__webpack_require__(4),ca=__webpack_require__(19),da=__webpack_require__(20),ea=__webpack_require__(21),ha=__webpack_require__(22),ia=__webpack_require__(23),C=__webpack_require__(24);
...
var App = function (_Component) {
    ...
    function App() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), _this), _this.filterItems = function (value) {
            var items = _this.props.items,
                loadCompleted = void 0;
        ...
        }, _this.checkHowManyItemsLeft = function (nextProps) {
            var countLeftItems = 0;

            nextProps.items.map(function (item) {
        ...
        }, _this.chooseAllCheck = function (nextProps) {
            var chooseAllChecked = void 0;

            if (_this.checkHowManyItemsLeft(nextProps) === 0 && nextProps.items.length !== 0) {
    ...
    _createClass(Input, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                items = _props.items,
                dispatch = _props.dispatch,
                chooseAllChecked = _props.chooseAllChecked;
            var text = this.state.text;

            return _react2.default.createElement(
                'div',
                { className: 'input_wrapper main_input_wrapper' },
                ...
                items.length > 0 ? _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', {
                        ...
                        id: 'choose_all',
                        onChange: function onChange(e) {
                            dispatch((0, _actions.setAllChecked)(e.target.checked));
                        },
                        checked: chooseAllChecked ? 'checked' : ''
                    }),
                    _react2.default.createElement('label', { htmlFor: 'choose_all' })
                ) : ''
            );
        }
    }]);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'ul',
                    null,
                    this.props.items.map(function (item, idx, arr) {
                        return _react2.default.createElement(_Item2.default, {
                            ...
                            chooseAllCheck: _this2.props.chooseAllCheck
                        });
                    })
                )
            );
...
var Item = function (_Component) {
    ...
    function Item(props) {
        ...
        _this.editInputHandler = function (e) {
            _this.setState({
                text: e.target.value
            });
        };
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                dispatch = _props.dispatch,
                _props$deleteManyItem = _props.deleteManyItems,
                deleteManyItems = _props$deleteManyItem === undefined ? false : _props$deleteManyItem,
                id = _props.id;
            var text = this.state.text;
                ...
                _react2.default.createElement(
                    'div',
                    {
                        ...
                        onDoubleClick: function onDoubleClick() {
                            return dispatch((0, _actions.changeEditing)(_this2.props.id));
                        }
                    },
                    _react2.default.createElement(
                        'div',
                    ...
                    _react2.default.createElement('div', {
                        className: 'remove',
                        onClick: function onClick() {
                            return dispatch((0, _actions.showModal)(deleteManyItems, id));
                        }
                    }),
    ...
    _createClass(Menu, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                dispatch = _props.dispatch,
                _props$deleteManyItem = _props.deleteManyItems,
                deleteManyItems = _props$deleteManyItem === undefined ? true : _props$deleteManyItem;
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'div',
                                {
                                    ...
                                    onClick: function onClick() {
                                        dispatch((0, _actions.setFilter)('ALL'));
                                    }
                                },
                                'All'
                            ),
                            _react2.default.createElement(
                                'div',
                                {
                                    ...
                                    onClick: function onClick() {
                                        dispatch((0, _actions.setFilter)('ACTIVE'));
                                    }
                                },
                                'Active'
                            ),
                            _react2.default.createElement(
                                'div',
                                {
                                    ...
                                    onClick: function onClick() {
                                        dispatch((0, _actions.setFilter)('COMPLETED'));
                                    }
                                },
                                'Completed'
                            )
                        ),
                        items.length - this.props.itemsLeft > 0 ? _react2.default.createElement(
                            'button',
                            {
                                id: 'clear_completed',
                                onClick: function onClick() {
                                    return dispatch((0, _actions.showModal)(deleteManyItems, null));
                                }
                            },
                            'Clear completed'
                        ) : ''
...
function store() {
    ...
    switch (action.type) {
        ...
        case _actions.CONFIRM_MODAL:
            return Object.assign({}, state, {
                items: state.itemIdToBeDeleted !== null ? state.items.filter(function (item) {
                    return item.id !== state.itemIdToBeDeleted;
